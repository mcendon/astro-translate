...
const modules = import.meta.glob<{ default: TranslationMap }>('/src/i18n/*.json', {
    eager: true,
})
 ...
 */
function getTranslationValue(translations: TranslationMap | undefined, key: string): unknown {
